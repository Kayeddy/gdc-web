  ...
  return (
    <div className="h-full w-full">
      <ReactPlayer
        ...
        playing={true}
        loop={true}
        // Shows a preview thumbnail if you want
        // playIcon={<button>Play</button>} // Custom play button
      />
    </div>
  );
};
...
export function CustomAboutBentoGrid() {
  return (
    <BentoGrid className="max-w-4xl mx-auto md:auto-rows-[45%]">
      {items.map((item, i) => (
        <BentoGridItem
          key={i}
          title={item.title}
...
const SkeletonFive = () => {
  return (
    ...
    >
      <VideoPlayer url="/launch_video.mp4" />
    </motion.div>
  );
};
const items = [
